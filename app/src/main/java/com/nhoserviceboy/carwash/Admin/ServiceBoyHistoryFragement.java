...
public class ServiceBoyHistoryFragement extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v= inflater.inflate(R.layout.fragment_service_boy_history, container, false);
        getId(v);
        return v;
    }
     public  void getId(View v)
    {
       ...
       /* name=v.getIntent().getStringExtra("name");
    ...
    private void Hit_get_book() {
        ...
        db.collection("BookingHistory").whereEqualTo("assigned_to_uid",uid).whereEqualTo("booking_status","Successful").whereEqualTo("dailybooking","").get()
