...
public class SignupActivityServiceBoy extends AppCompatActivity implements View.OnClickListener , GoogleApiClient.ConnectionCallbacks,
    ...
    protected synchronized void buildGoogleApiClient() {
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .addConnectionCallbacks(SignupActivityServiceBoy.this)
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            status.startResolutionForResult(SignupActivityServiceBoy.this, REQUEST_CHECK_SETTINGS);
    ...
    public void onClick(View view) {
        ...
        if (view == tv_signup)
        {
            ...
            {  ed_email.setError("Enter Email");
                ...
                if (UtilMethods.INSTANCE.isNetworkAvialable(SignupActivityServiceBoy.this))
                {
                    loader.show();
...
*/
                ...
                {
                    UtilMethods.INSTANCE.Error(SignupActivityServiceBoy.this, getResources().getString(R.string.network_error_message));
                }
    ...
    private void addDataToFirestore(String email, String phonenumber ,String username , String Address, String Landmark,String loginType) {
        ...
        RegisterModel courses = new RegisterModel(email, phonenumber, username  ,Address,  Landmark  ,latitude,longitude, loginType ,user.getUid(),"");
        ...
        dbCourses.document(user.getUid()).set(courses).addOnSuccessListener(new OnSuccessListener<Void>()
                {
                    ...
                    public void onSuccess(Void aVoid)
                    {
                       // db.collection("BookingHistory").document(user.getUid()).update("uiToken",tokenId);
                        UtilMethods.INSTANCE.setLoginrespose(SignupActivityServiceBoy.this,email+"",phonenumber+"" ,
                        ""+username ,"1" ,user.getUid(),Address ,Landmark ,latitude,longitude );
                      Toast.makeText(SignupActivityServiceBoy.this, "Service Boy  Created ", Toast.LENGTH_SHORT).show();
                       ...
                       /* Log.d("","jdshfhfieoi9r"+user.getUid());
                        ...
                        Intent home = new Intent(SignupActivityServiceBoy.this, DashBoadAdminActivity.class);
                       startActivity(home);
                     finish();
