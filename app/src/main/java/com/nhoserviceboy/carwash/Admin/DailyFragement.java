...
public class DailyFragement extends Fragment {
    ...
    {
        View v= inflater.inflate(R.layout.fragment_daily_fragement, container, false);
    ...
    private void Hit_get_book()
    {
        ...
        db.collection("BookingHistory").whereEqualTo("booking_status","pending").whereEqualTo("dailybooking","dailyCleaning").get()
                                    ...
                                    tv_assigned.setOnClickListener(new View.OnClickListener()
                                    {
                                        ...
                                        public void onClick(View view)
                                        {
                                            ...
                                            if (status_assi.trim().equalsIgnoreCase("0"))
                                            {
                                                ...
                                                Log.d("", "fuusdfusfy" + d.getString("dailybooking")+""+ d.getString("exdate"));
