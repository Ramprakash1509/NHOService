...
public class CompletededService extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        View v= inflater.inflate(R.layout.fragment_completeded_service, container, false);
        GetID(v);
        return v;
    }
...

    {
        ...
        db.collection("BookingHistory").whereEqualTo("paymenttype","Successful").get()
                    .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>()
                    {
                        ...
                        public void onSuccess(QuerySnapshot queryDocumentSnapshots)
                        {
                            ...
                            if (!queryDocumentSnapshots.isEmpty())
                            {
                                ...
                                {
                                   /* if(d.getString("paymenttype").equalsIgnoreCase("Successful"))
                                    {*/
                                         ...
                                         /*   tv_assigned.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View view) {
                                                    ...
                                                    if (status_assi.trim().equalsIgnoreCase("0")) {
                                                        ...
                                                        Log.d("", "fuusdfusfy" + d.getString("user_id"));
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        Toast.makeText(getActivity(), "This booking already Completed by  Mr. " + status_assi, Toast.LENGTH_SHORT).show();
                                                    }
