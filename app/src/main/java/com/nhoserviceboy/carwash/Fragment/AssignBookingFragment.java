...
public class AssignBookingFragment extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        View v=inflater.inflate(R.layout.fragment_assign_booking, container, false);
        GetID(v);
        return v;
    }
    @Override
...

    {
        ...
        db.collection("BookingHistory").whereEqualTo("booking_status","Assigned").get()
                            ...
                            for (DocumentSnapshot d : list)
                            {
                                    ...
                                    if (getActivity() != null)
                                    {
                                        ...
                                        if (!status_assi.trim().equalsIgnoreCase("0"))
                                        {
                                            ...
                                            tv_assigned.setText("   Assigned  To "+d.getString("assigned_to"));
                                        } else {
